...
|-----------|-------------|-----------------|------------------|
| [Two Pointers](./two-pointers) | Used for searching pairs in sorted arrays or finding ranges that meet certain conditions. Particularly effective for sorted arrays, subarrays, and when processing elements from both ends. Helps avoid the $$O(n^2)$$ complexity of nested loops. | $$O(n)$$ | $$O(1)$$ |
